...
const SAMPLE_DATA = [
  { specialty:"Cardiology", state:"TX", setting:"Hospital", yrsExp:8, base:475000, bonus:50000, rvu:8200, rvuRate:58, ptoWeeks:5, call:"1:4", nonCompete:"20mi/2yr", tailCovered:true },
  { specialty:"Emergency Medicine", state:"FL", setting:"Group", yrsExp:5, base:380000, bonus:20000, rvu:0, rvuRate:0, ptoWeeks:4, call:"shift", nonCompete:"None", tailCovered:true },
  { specialty:"Orthopedic Surgery", state:"CA", setting:"Private", yrsExp:12, base:520000, bonus:80000, rvu:12000, rvuRate:52, ptoWeeks:4, call:"1:5", nonCompete:"15mi/1yr", tailCovered:false },
  { specialty:"Internal Medicine", state:"NY", setting:"Academic", yrsExp:3, base:240000, bonus:10000, rvu:5200, rvuRate:44, ptoWeeks:4, call:"1:6", nonCompete:"None", tailCovered:true },
  ...
  { specialty:"Dermatology", state:"IL", setting:"Private", yrsExp:10, base:450000, bonus:100000, rvu:7500, rvuRate:65, ptoWeeks:5, call:"None", nonCompete:"10mi/1yr", tailCovered:true },
  { specialty:"Anesthesiology", state:"OH", setting:"Hospital", yrsExp:6, base:420000, bonus:30000, rvu:0, rvuRate:0, ptoWeeks:5, call:"1:4", nonCompete:"25mi/2yr", tailCovered:true },
  { specialty:"Family Medicine", state:"MN", setting:"Hospital", yrsExp:4, base:275000, bonus:15000, rvu:5800, rvuRate:42, ptoWeeks:4, call:"1:5", nonCompete:"None", tailCovered:true },
];
