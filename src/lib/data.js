...
export const MODULES = {
  ...
  partnership:    { label:"Partnership Track",   icon:"◎", tier:"pro",        color:"#60a5fa", cat:"Career" },
  locumrates:     { label:"Locum Rates",         icon:"◎", tier:"pro",        color:"#fbbf24", cat:"Career" },
  charitable:     { label:"Giving Optimizer",    icon:"◎", tier:"pro",        color:"#a78bfa", cat:"Tax" },
  checklists:     { label:"Checklists",          icon:"◎", tier:"free",    color:"#34d399", cat:"Core" },
  w4optimizer:    { label:"W-4 Optimizer",       icon:"◎", tier:"free",    color:"#a78bfa", cat:"Tax" },
