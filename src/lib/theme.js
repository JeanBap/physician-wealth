...
export const THEMES = {
  dark: {
    ...
    chartBarFill: "rgba(255,255,255,0.06)", chartBarBg: "rgba(255,255,255,0.02)", chartCircle: "rgba(255,255,255,0.04)",
  ...
  light: {
    ...
    chartBarFill: "rgba(0,0,0,0.06)", chartBarBg: "rgba(0,0,0,0.02)", chartCircle: "rgba(0,0,0,0.04)",
