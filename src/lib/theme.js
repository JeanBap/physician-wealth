...
export const THEMES = {
  dark: {
    ...
    chartBarFill: "rgba(255,255,255,0.12)", chartBarBg: "rgba(255,255,255,0.05)", chartCircle: "rgba(255,255,255,0.08)",
  ...
  light: {
    ...
    chartBarFill: "rgba(0,0,0,0.15)", chartBarBg: "rgba(0,0,0,0.06)", chartCircle: "rgba(0,0,0,0.08)",
